import { Coins, GoalIcon, ListPlusIcon, PiggyBank } from 'lucide-react'
        ...
        <div className='mt-4 grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4'>
            <div className='flex p-4 items-center justify-between border shadow-md rounded-lg'>
                <div className='flex flex-col gap-1'>
                    ...
                    <h2 className='text-xl flex items-center gap-3 font-bold'>${goal>0? Number(goal).toFixed(2) : 0}</h2>
                </div>
            ...
            <div className='flex p-4 items-center justify-between border shadow-md rounded-lg'>
                <div className='flex flex-col gap-1'>
                    ...
                    <h2 className='text-xl flex items-center gap-3 font-bold'>${saved>0? Number(saved).toFixed(2) :0}</h2>
                </div>
                <div className='bg-primary text-white rounded-full p-3'>
                    <PiggyBank />
                </div>
            ...
            <div className='flex p-4 items-center justify-between border shadow-md rounded-lg'>
                <div className='flex flex-col gap-1'>
                    ...
                    <h2 className='text-xl flex items-center gap-3 font-bold'>${left>0? Number(left).toFixed(2) : 0}</h2>
                </div>
                <div className='bg-primary text-white rounded-full p-3'>
                    <Coins />
                </div>
