...
const PendingBillsComponent = ({pending, charge, setPaid, createNextBill,setcharge, deleteBill }) => {
  return (
    <div className='mt-5'>
    ...
    {pending.length > 0 ? <div className='grid gap-4 mt-5 md:grid-cols-2 lg:grid-cols-3 sm:grid-cols-1'>
      {pending.map((bill, index) => (
        ...
        <div key={index} className="p-4 border rounded-lg">
          ...
          <div className='flex mt-5 justify-start items-center text-destructive'>
          <AlertDialog>
